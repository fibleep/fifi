...
class Correlation:
    def __init__(self, df: pl.DataFrame, method:Literal['pearson', 'spearman'] = 'pearson', encoder:Literal['label', 'one_hot'] = 'label'):
        self.df = df
        self.method = method
    ...
    def show(self):
        ...
        corr = df.to_pandas().corr(method=self.method)
